  ...
  const moodCategories = [
    {
      ...
      moods: ["happy", "excited", "grateful", "hopeful"],
    },
    {
      title: "Calm Emotions",
      moods: ["calm", "neutral"],
    },
    {
      ...
      moods: ["sad", "angry", "anxious", "confused"],
    },
  ];
    ...
    <div className="mood-legend">
      ...
      <div className="legend-content">
        {moodCategories.map((category, index) => (
          <div key={index} className="mood-category">
            ...
            <div className="mood-items">
              {category.moods.map((mood) => (
                <div key={mood} className="mood-item">
                  ...
                  />
                  <span className="mood-emoji">{MOOD_COLORS[mood].emoji}</span>
